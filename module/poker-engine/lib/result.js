...
Result.rankHandInt = function (hand) {
    ...
    if (rank === 0) {
        ...
        else if (suits.indexOf('DDDDD') > -1) {
            flushSuit = "D";
        } else if(suits.indexOf('HHHHH') > -1) {
            flushSuit = "H";
        } else if(suits.indexOf('SSSSS') > -1) {
            flushSuit = "S";
        }
        ...
        if (rank === 123) { 
            ...
            for(let i = 0; i < hand.cards.length; i ++) {
                if(hand.cards[i].charAt(1) == flushSuit) {
                    flushRank += hand.cards[i].charAt(0);
                }
            }
            rank = rank + Result.rankKickers(flushRank, 5);
        }
